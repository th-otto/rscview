...
static unsigned char const atari_toupper[256] = {
	...
	0x80, 0x9a, 0x82, 0x83, 0x8e, 0x85, 0x86, 0x87, 0x88, 0x89, 0x8a, 0x8b, 0x8c, 0x8d, 0x8e, 0x8f,
...
static const char *get_keylabel(unsigned char c)
{
	...
	switch (c)
	{
		...
		if (c < 0x20 || c >= 0x80)
		{
			sprintf(labelbuf, "&#x%04x;", atari_to_unicode[c]);
			return labelbuf;
		}
	}
	labelbuf[0] = c;
...
<svg\n\
   ...
   height=\"270px\"\n\
  <g>\n\
    <path class=\"rect\" id=\"scan59\" d=\"M 20,10 L 75,10 L 65,40 L 10,40 L 20,10\" />\n\
    <text class=\"keylabel\" x=\"55\" y=\"22\">F1</text>\n\
    <text class=\"scanlabel\" x=\"28\" y=\"30\">0x3b</text>\n\
    <path class=\"rect\" id=\"scan60\" d=\"M 75,10 L 130,10 L 120,40 L 65,40 L 75,10\" />\n\
    <text class=\"keylabel\" x=\"110\" y=\"22\">F2</text>\n\
    <text class=\"scanlabel\" x=\"83\" y=\"30\">0x3c</text>\n\
    <path class=\"rect\" id=\"scan61\" d=\"M 130,10 L 185,10 L 175,40 L 120,40 L 130,10\" />\n\
    <text class=\"keylabel\" x=\"165\" y=\"22\">F3</text>\n\
    <text class=\"scanlabel\" x=\"138\" y=\"30\">0x3d</text>\n\
    <path class=\"rect\" id=\"scan62\" d=\"M 185,10 L 240,10 L 230,40 L 175,40 L 185,10\" />\n\
    <text class=\"keylabel\" x=\"220\" y=\"22\">F4</text>\n\
    <text class=\"scanlabel\" x=\"193\" y=\"30\">0x3e</text>\n\
    <path class=\"rect\" id=\"scan63\" d=\"M 240,10 L 295,10 L 285,40 L 230,40 L 240,10\" />\n\
    <text class=\"keylabel\" x=\"275\" y=\"22\">F5</text>\n\
    <text class=\"scanlabel\" x=\"248\" y=\"30\">0x3f</text>\n\
    <path class=\"rect\" id=\"scan64\" d=\"M 295,10 L 350,10 L 340,40 L 285,40 L 295,10\" />\n\
    <text class=\"keylabel\" x=\"330\" y=\"22\">F6</text>\n\
    <text class=\"scanlabel\" x=\"303\" y=\"30\">0x40</text>\n\
    <path class=\"rect\" id=\"scan65\" d=\"M 350,10 L 405,10 L 395,40 L 340,40 L 350,10\" />\n\
    <text class=\"keylabel\" x=\"385\" y=\"22\">F7</text>\n\
    <text class=\"scanlabel\" x=\"358\" y=\"30\">0x41</text>\n\
    <path class=\"rect\" id=\"scan66\" d=\"M 405,10 L 460,10 L 450,40 L 395,40 L 405,10\" />\n\
    <text class=\"keylabel\" x=\"440\" y=\"22\">F8</text>\n\
    <text class=\"scanlabel\" x=\"413\" y=\"30\">0x42</text>\n\
    <path class=\"rect\" id=\"scan67\" d=\"M 460,10 L 515,10 L 505,40 L 450,40 L 460,10\" />\n\
    <text class=\"keylabel\" x=\"495\" y=\"22\">F9</text>\n\
    <text class=\"scanlabel\" x=\"468\" y=\"30\">0x43</text>\n\
    <path class=\"rect\" id=\"scan68\" d=\"M 515,10 L 570,10 L 560,40 L 505,40 L 515,10\" />\n\
...
", out);
	...
	for (i = 0; i < ARRAY_SIZE(svgtable); i++)
	{
		...
		if (scancode == 0x1c)
		{
			...
			fprintf(out, "    <path class=\"rect\" id=\"scan%u\" d=\"M %d,%d L %d,%d L %d,%d L %d,%d L %d,%d L %d,%d L %d,%d\" />\n",
				scancode,
		...
		{
			fprintf(out, "    <rect class=\"rect\" id=\"scan%u\"%-*s width=\"%d\" height=\"%d\" x=\"%d\"%-*s y=\"%d\"/>\n",
				scancode,
				INT_SPACE(svgtable[i].scancode),
				wkey,
				svgtable[i].h,
				svgtable[i].x,
		...
		if (keytab[TAB_SHIFT][scancode] != 0 &&
			...
			keytab[TAB_SHIFT][scancode] != atari_toupper[keytab[TAB_UNSHIFT][scancode]])
		{
