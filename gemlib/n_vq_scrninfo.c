/*
 *  $Id: n_vq_scrninfo.c,v 1.6 2003/08/07 06:38:20 a_bercegeay Exp $
 */
...
\verbatim
   ...
   ---------|--------|-----------------------------------------------------
     ...
     17     |  12    | bit 1 of the red intensity is bit 12 of the pixel
     18     |  13    | ...
     19     |  14    | ...
     ...
     33     |   7    | bit 1 of the green intensity is bit 7 of the pixel
     34     |   8    | ...
     35     |   9    | ...
     36     |  10    | bit 4 of the green intensity (most significant bit)
            |        | is bit 10 of the pixel
     37..47 |  -1    | bits are not used
            |        |
            |        |
