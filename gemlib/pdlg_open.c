/*
 *  $Id: pdlg_open.c,v 1.5 2003/02/28 20:46:41 a_bercegeay Exp $
 */
...
short
mt_pdlg_open(PRN_DIALOG *prn_dialog, PRN_SETTINGS *settings, const char *document_name,
...
short (pdlg_open)(PRN_DIALOG *prn_dialog, PRN_SETTINGS *settings, const char *document_name, short option_flags, short x, short y)
{
