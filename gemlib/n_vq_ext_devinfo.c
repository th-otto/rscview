/*
 *  $Id: n_vq_ext_devinfo.c,v 1.5 2003/08/07 06:36:09 a_bercegeay Exp $
 */
                ...
                short *dev_exists, char *file_path, char *file_name, char *name)
{
	...
	short vdi_intin[1 + 3 * VDI_NPTRINTS];
	short vdi_intout[2]; 
	...
	vdi_intin_ptr(1 + VDI_NPTRINTS, char *) = file_name;
	vdi_intin_ptr(1 + 2 * VDI_NPTRINTS, char *) = name;

	VDI_TRAP_ESC (vdi_params, handle, 248,4242, 0, 1 + 3 * VDI_NPTRINTS);
