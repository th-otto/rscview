/*
 *  $Id: pdlg_do.c,v 1.5 2003/02/28 20:46:41 a_bercegeay Exp $
 */
           ...
           short option_flags, short *global_aes)
{
	...
	aes_addrin[3] = NO_CONST(document_name);
...
short (pdlg_do)(PRN_DIALOG *prn_dialog, PRN_SETTINGS *settings, const char *document_name, short option_flags)
{
