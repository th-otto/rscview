/*
 *  $Id: n_v_getoutline.c,v 1.6 2003/08/07 06:33:49 a_bercegeay Exp $
 */
              ...
              short maxverts, short *numverts)
{
	...
	vdi_intin_ptr(2 + VDI_NPTRINTS, char *) = bezarray;
	
	VDI_TRAP (vdi_params, handle, 243, 0, 2 + 2 * VDI_NPTRINTS);
}
