...
static _UWORD const rgb_tab[] = {
	0xFFDF, 0xF800, 0x07C0, 0xFFC0, 0x001F, 0xF81F, 0x07DF, 0xB596, 0x8410, 0xA000, 0x0500,
	0xA500, 0x0014, 0xA014, 0x0514, 0x0, 0xFFDF, 0xE71C, 0xD69A, 0xC618, 0xB596,
...
static void just_draw(OBJECT *tree, _WORD obj, _WORD sx, _WORD sy)
{
	...
	if (obtype != G_STRING)
	{
		...
		case G_FTEXT:
		case G_FBOXTEXT:
			strmcpy(rawstr, sizeof(rawstr), edblk.te_ptext);
			strmcpy(tmpstr, sizeof(tmpstr), edblk.te_ptmplt);
