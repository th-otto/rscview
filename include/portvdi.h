...
void    v_opnwk( _WORD work_in[16],  _WORD *handle, _WORD *work_out);
void    v_clswk( _WORD handle );
void    v_opnvwk( _WORD work_in[11], _WORD *handle, _WORD *work_out);
...
_WORD v_write_bmp(_WORD handle, const char *filename);
